...
class CloudVisionTest(image: Image, mode: String) {
    ...
    fun performAnalyze(): String? {
        try {
            ...
            var requestInitializer : VisionRequestInitializer =  InitializerFactory.getInitializer(CLOUD_VISION_API_KEY, CameraActivity.PACKAGE_MANAGER, CameraActivity.PACKAGE_NAME) //VisionRequestInitializer(CLOUD_VISION_API_KEY) // TODO repair later InitializerFactory.getInitializer(CLOUD_VISION_API_KEY, main)

            builder.setVisionRequestInitializer(requestInitializer)
            var vision: Vision = builder.setApplicationName("test").build()
