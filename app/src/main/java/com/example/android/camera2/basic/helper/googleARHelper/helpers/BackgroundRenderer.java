 ...
 */
package com.example.android.camera2.basic.helper.googleARHelper.helpers;
...
public class BackgroundRenderer {
   ...
   * the OpenGL thread, typically in {@link GLSurfaceView.Renderer#}.
   *
   ...
   * com.example.android.camera2.basic.helper.googleARHelper.helpers.BackgroundRenderer#quadTexCoords} image texture coordinates.
   */
  private void draw() {
