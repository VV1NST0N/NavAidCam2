...
public class BitmapUtil {
    ...
    public static Bitmap getBitmap(Image image, Image.Plane[] planes, Integer rotation, Integer width, Integer height ) {
        ...
        ByteBuffer nv21Buffer =
                yuv420ThreePlanesToNV21(planes, image.getWidth(), image.getHeight());
